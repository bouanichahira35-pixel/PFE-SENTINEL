...
const PERMISSION_META = Object.freeze({
  ...
  [PERMISSIONS.USER_LIST]: { label: 'Lister utilisateurs', area: 'utilisateurs' },
  [PERMISSIONS.USER_STATUS_UPDATE]: { label: 'Bloquer/Débloquer utilisateurs', area: 'utilisateurs' },
  [PERMISSIONS.USER_PROFILE_UPDATE]: { label: 'Mettre à jour profil utilisateur', area: 'utilisateurs' },
  [PERMISSIONS.USER_CREATE]: { label: 'Créer utilisateurs', area: 'utilisateurs' },
  [PERMISSIONS.USER_ROLE_UPDATE]: { label: 'Modifier rôle utilisateur', area: 'utilisateurs' },
  [PERMISSIONS.USER_PASSWORD_RESET]: { label: 'Réinitialiser mot de passe', area: 'utilisateurs' },
  [PERMISSIONS.USER_MANAGE]: { label: 'Gérer utilisateurs (legacy)', area: 'utilisateurs' },
...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  responsable: new Set([
    ...
    PERMISSIONS.PURCHASE_ORDER_MANAGE,
    PERMISSIONS.INVENTORY_MANAGE,
    // Gestion utilisateurs (limitée) : demandeurs/magasiniers + profil catalogue.
