 ...
 import { User, Lock, Moon, Sun, Globe, Bell, Camera, Save, Settings, Users, Bot, ShieldCheck } from 'lucide-react';
               ...
               {activeTab === 'regles' && (
                 <div className="param-section">
                   ...
                   <div className="form-group">
                    ...
                    <div className="toggle-item" style={{ opacity: 0.85 }}>
                      <div>
                        <span className="toggle-label">Ajout direct des nouveaux produits</span>
                        <span className="toggle-desc">Les nouveaux produits ajoutés par le magasinier sont utilisables immédiatement.</span>
                      </div>
                    </div>
                   <button className="btn-save resp">
                     <Save size={16} />
