...
import { Package, History, FileText, MessageCircle, Settings, ChevronLeft, ChevronRight, LogOut, Plus, ArrowDownToLine, ArrowUpFromLine } from 'lucide-react';
...
const SidebarMag = ({ collapsed, onToggle, onLogout }) => {
  ...
  const menuItems = [
    ...
    { icon: Settings, label: 'Parametres', path: '/magasinier/parametres' },
  ];
