...
const SidebarResp = ({ collapsed, onToggle, onLogout, userName }) => {
  ...
  const labels = useMemo(() => ({
    fr: {
      ...
      lotsASurveiller: 'Lots à surveiller',
    ...
    en: {
      ...
      lotsASurveiller: 'Batches to watch',
    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          { key: 'lots', icon: Layers, label: labels.lotsASurveiller, to: '/responsable/produits', search: 'filter=lots', badge: badges.lots },
